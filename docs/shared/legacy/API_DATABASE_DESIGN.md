...
> **Note:** This comprehensive document has been split into focused documents for easier navigation. See [../../README.md](../../README.md) for the new structure.

**Split Documents:**
- [DATABASE_SCHEMA.md](../../backend/DATABASE_SCHEMA.md) - Database schema and file system structure
- [TASK_CONFIGURATION.md](../../backend/TASK_CONFIGURATION.md) - Task definitions and execution logic
- [API_REFERENCE.md](../API_REFERENCE.md) - Complete API endpoint documentation
- [USER_JOURNEYS.md](../../frontend/USER_JOURNEYS.md) - User flows and system interactions
- [IMPLEMENTATION.md](../../backend/IMPLEMENTATION.md) - Step-by-step implementation guide
- [SETUP.md](../../backend/SETUP.md) - Environment variables, error codes, and retry strategies
- [INTEGRATIONS.md](../../backend/INTEGRATIONS.md) - External API integration details
